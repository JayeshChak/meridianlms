...
export const formDataSchema = z.object({
	...
	course_id: z.string().uuid({ message: "Session/Course is required" }),
	...
	maxDownloads: z
		...
		.max(1000, { message: "Maximum Downloads cannot exceed 1000" }),
	...
	certificateImage: z
		...
		.refine(
			...
			{
				message:
					"Certificate Image must be a valid file and not exceed 5MB",
			}
		),
});
