		...
		<div className="max-w-4xl mx-auto p-6">
			<div className="mb-8">
				...
				<p className="text-gray-600">
					Enter the certificate title to check its status
				</p>
			</div>
					...
					<div className="space-y-4">
						<div>
							...
							<p className="font-medium">
								{certificate_data_url.title}
							</p>
						</div>
						{certificate_data_url.description && (
							<div>
								<label className="text-sm text-gray-500">
									Description
								</label>
								<div
									...
									dangerouslySetInnerHTML={{
										__html: certificate_data_url.description,
									}}
								/>
							</div>
						)}
						{certificate_data_url.courseTitle && (
							<div>
								<label className="text-sm text-gray-500">
									Course
								</label>
						...
						<div>
							...
							<p
								className={`font-medium ${
									certificate_data_url.is_published
										? "text-green-600"
										: "text-yellow-600"
								}`}
							>
						...
						<div>
							...
							<p className="font-medium">
								{new Date(
									certificate_data_url.created_at
								).toLocaleDateString()}
							</p>
						</div>
					</div>
