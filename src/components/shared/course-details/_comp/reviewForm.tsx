...
const ReviewForm = ({ course_id, addReview }) => {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (response.ok) {
				...
				showAlert(
					"error",
					result.message || "Failed to submit the review"
				);
			}
		} catch (error) {
...
//     //   const course_id = "c65976ec-6ac5-4f35-8c05-f444635f54c1";
