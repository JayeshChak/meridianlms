				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-30px">
					...
					<div data-aos="fade-up">
						...
						<p className="text-contentColor dark:text-contentColor-dark leading-1.8 mb-15px mt-5">
							Share your knowledge and passion with learners
							around the world. As an instructor, you have the
							opportunity to create engaging Courses, reach a
							global audience, and make a significant impact on
							students&lsquo; lives while earning income.
						</p>
						<p className="text-contentColor dark:text-contentColor-dark leading-1.8 mb-15px mt-5">
							Join our vibrant community of educators and experts.
							We provide you with the tools and support needed to
							develop high-quality Courses and succeed in the
						...
						<p className="text-contentColor dark:text-contentColor-dark leading-1.8 mb-15px mt-5">
							To ensure the best learning experience for our
							students, we ask our instructors to adhere to the
						...
						<ul className="mb-30px space">
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Deliver high-quality content that is
							...
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Respect all students and provide a
							...
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Respond promptly to student questions and
									feedback.
								</p>
							</li>
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Uphold academic integrity and originality in
							...
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Comply with our platform policies and terms
									of service.
								</p>
							</li>
						</ul>
						...
						<p className="text-contentColor dark:text-contentColor-dark leading-1.8 mb-15px mt-5">
							Embark on your teaching journey by creating your
							first course. We offer comprehensive resources to
							help you design, develop, and promote your course
							effectively.
						</p>
						{/* Rules list */}
						<ul className="mb-30px space">
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Utilize our intuitive course creation tools
							...
							<li className="mt-5 flex items-center gap-5">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Access a wealth of resources and best
									practices for course development.
								</p>
							</li>
							<li className="mt-5 flex items-center gap-5">
								<div className="h-25px w-25px">
								...
								<p className="text-contentColor dark:text-contentColor-dark leading-1.8">
									Engage with a community of instructors to
									exchange ideas and advice.
								</p>
							</li>
						</ul>
						<p className="text-contentColor dark:text-contentColor-dark leading-1.8 mb-15px mt-5">
							Ready to make a difference? Join us today and start
							sharing your expertise with eager learners
							everywhere.
						</p>
					</div>
