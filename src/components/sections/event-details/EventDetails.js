...
const EventDetails = () => {
	return (
		<section>
			<div className="container py-20px md:py-30px lg:py-10 2xl:py-50px">
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-30px">
						...
						<div data-aos="fade-up" className="mt-35px mb-30px">
							...
							<div>
								...
								<p
									...
									data-aos="fade-up"
								>
									He legged it up the kyver have it mush super
									me old mucker cheeky naff that are you
									taking the piss, blow off ruddy the pub bite
									your arm off the wireless boot cor blimey
									guvnor happy days bender what a load of
									rubbish, say cheers pardon me horse play
									spiffing Why car boot gosh bubble and
									squeak. Cheers Richard bugger show off show
									Que pick your nose and blow off get stuffed
									mate chancer in my flat loo, bevvy amongst
									hunky-dory bender bubb Matie and squeak me
									old mucker vagabond, barmy spend a penny
									chimney pot young delinquent bum bag the
									nancy arm knees chap, gosh nice one knees up
									the wireless Charles such a fibber. Mush
									barmy bleeding Jeffrey pardon nose barney
									grub loo cup of tea bubble and squeak bugger
									all mate say, I bloke matie boy tickety-boo
									give us the duff bugger lurgy wind up I{" "}
									{"don't"} want no agro.
								</p>
								...
								<ul data-aos="fade-up">
									...
									<li>
										<p className="text-contentColor dark:text-contentColor-dark mb-10px !leading-29px">
											<i className="icofont-check text-primaryColor"></i>
											Downloadable Lectures, code and
									...
									<li>
										<p className="text-contentColor dark:text-contentColor-dark mb-10px !leading-29px">
											<i className="icofont-check text-primaryColor"></i>{" "}
											Anyone who is finding a chance to
											get the promotion
										</p>
									</li>
								</ul>
					...
					<div className="lg:col-start-9 lg:col-span-4">
						...
						>
							...
							<p className="text-contentColor dark:text-contentColor-dark font-semibold leading-19px mb-15px"></p>
