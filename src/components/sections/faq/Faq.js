		...
		<section>
			<div className="container pb-100px">
				<div className="fees faq grid grid-cols-1 lg:grid-cols-12 gap-30px">
					...
					{/* accordions */}
					<div
						className="lg:col-start-4 lg:col-span-9"
						data-aos="fade-up"
					>
						<AccordionContainer>
									...
									<AccordionContent>
										<div className="content-wrapper py-4 px-5">
											<p className="leading-7 text-contentColor dark:text-contentColor-dark mb-15px">
												Non similique culpa in provident
												quos sit commodi beatae ea
												laborum suscipit id autem velit
												aut iusto odio et deleniti quis
												et doloremque enim vel
												consequuntur quos.
											</p>
										</div>
									</AccordionContent>
