...
const CreateCoursePrimary = () => {
	...
	// console.log("course add course id from chapter Items",course_id)
	...
	const updateCourseStatus = async (course_id) => {
		if (!course_id && initialCourseData) {
			course_id = initialCourseData.id;
		}
					...
					<div className="lg:col-start-1 lg:col-span-8">
						<ul className="accordion-container curriculum create-course">
							...
							<li className="accordion mb-5">
								<CertificatesTemp
									course_id={
										"facb9619-4627-4c54-8bf4-07bcede7d70a"
									}
								/>
							</li>
